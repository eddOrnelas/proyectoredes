 ...
 */
	public static function checkSecurityKeys() {
		if (Configure::read('Security.salt') === 'winwardiumlabiosaaaaawinwardiumlabiosaaaaa') {
		...
		if (Configure::read('Security.cipherSeed') === 'winwardiumlabiosaaaaawinwardiumlabiosaaaaa') {
